  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700">
        <div >
           ...
           <div >
            <img src={assets.quality_icon} className="w-12 m-auto mb-5" alt="exchangeICON" />
           <p className="font-semibold">7 Days Return Policy</p>
           <p className="text-gray-400">We offer 7 days free return policy</p>
        </div>
           <div >
            <img src={assets.support_img} className="w-12 m-auto mb-5" alt="exchangeICON" />
           <p className="font-semibold">Best Customer Service</p>
           <p className="text-gray-400">We provide 24/7 free customer support</p>
        </div>
    </div>
  );
};
